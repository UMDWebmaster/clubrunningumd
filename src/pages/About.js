			...
			<section id="pres" class="wrapper style1">
				<div class="inner">
					...
					<article class="about-us-card2">
						...
						<div class="content">
							<h2>Vice President: Lillian Hsu</h2>
							<p>Lillian is an environmental science major from Germantown, Maryland. After working for a semester as an unpaid intern under the President Diana administration, she is now doing even more unpaid work but now as your Vice President! Outside of running, she enjoys art, crocheting, and Moge Tee.
								She can also be found taking pictures at meets (and pawning the camera off on unsuspecting club members when it&#39;s time for her race).</p>
					...
					<article class="about-us-card2">
						...
						<div class="content">
							<h2>Co-Treasurer: Jacob Bush</h2>
							<p>Jacob is a sophomore studying computer science. He ran for treasurer because he felt like managing more than the usual 2 digit number in his personal bank account. He is currently trying his best to fight tax fraud and a suppressed gambling addiction. When he&#39;s not frolicking in club funds he enjoys ice skating, impromptu sports, and most of all being with his friends. If you ever want to talk about life and all of its crazy intricacies you should go meet him!</p>
					...
					<article class="about-us-card2">
						...
						<div class="content">
							<h2>Team Apparel Coordinator: Eamon Plante</h2>
							<p>Eamon Plante, a computer science major, has been a club member since he was a freshman in 2020. Before attending UMD, he ran cross country and track at Sherwood High School and was a team captain. He also makes very lame bios</p>
					...
					<article class="about-us-card2">
						...
						<div class="content">
							<h2>Webmaster: Caleb Holland</h2>
							<p>Caleb Holland is a freshman studying computer science. More commonly known as C Holland, Caleb is known for his absolutely breathtaking strava content, and crowning achievement as the 2023 hot sauce night co-champion. In his free time, Caleb ponders life's biggest questions, such as: "Should you salt your chocolate milk?" and "does pizza taste better upside down?" Talk to Caleb if you ever want to discuss fascinating topics such as these.</p>
